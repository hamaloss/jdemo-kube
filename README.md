...
```
$ docker image tag app harbor.teco.1-4.fi.teco.online/jdemo/app
$ docker push harbor.teco.1-4.fi.teco.online/jdemo/app
$ docker image tag ms1 harbor.teco.1-4.fi.teco.online/jdemo/ms1
$ docker push harbor.teco.1-4.fi.teco.online/jdemo/ms1
$ docker image tag uaa harbor.teco.1-4.fi.teco.online/jdemo/uaa
$ docker push harbor.teco.1-4.fi.teco.online/jdemo/uaa
```
...
```
$ kubectl scale deployment <app-name> --replicas <replica-count> -n jdemo
```
...
```
$ kubectl set image deployment/<app-name>-app <app-name>=<new-image>  -n jdemo
```
...
```
$ kubectl get svc jhipster-console -n jdemo
```
...
```
$ kubectl expose service jhipster-registry --type=NodePort --name=exposed-registry -n jdemo
```

and explore the details using

```
$ kubectl get svc exposed-registry -n jdemo
```

For scaling the JHipster registry, use

```
$ kubectl scale statefulset jhipster-registry --replicas 3 -n jdemo
```
